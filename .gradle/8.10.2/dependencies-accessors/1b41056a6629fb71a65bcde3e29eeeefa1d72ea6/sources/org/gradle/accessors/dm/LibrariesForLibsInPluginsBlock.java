...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AdsLibraryAccessors extends SubDependencyFactory {
        private final AdsMobileLibraryAccessors laccForAdsMobileLibraryAccessors = new AdsMobileLibraryAccessors(owner);

        public AdsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ads.mobile</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AdsMobileLibraryAccessors getMobile() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAdsMobileLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AdsMobileLibraryAccessors extends SubDependencyFactory {

        public AdsMobileLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.google.android.libraries.ads.mobile.sdk:ads-mobile-sdk</b> coordinates and
         * with version reference <b>adsMobileSdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxFoundationLayoutLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>foundationLayoutAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adsMobileSdk</b> with value <b>0.15.1-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAdsMobileSdk() { return getVersion("adsMobileSdk"); }
        ...
        /**
         * Version alias <b>foundationLayoutAndroidVersion</b> with value <b>1.6.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
